...
function login(reqUsername, reqPassword){
  ...
  //var matchUser = dbUsers.find(    
    ...
    //)
    let matchUser = client.db('server1')
        .collection('users')
...
function register(username, password, name, email){
    client.db('server1').collection('users').insertOne({
...
const uri = "mongodb+srv://mdanialaqib:mdanialaqib123@cluster0.zgb9fq5.mongodb.net/?retryWrites=true&w=majority";
